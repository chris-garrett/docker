...
`docker pull ghcr.io/chris-garrett/python:26.23.0`
...
`docker pull ghcr.io/chris-garrett/rust:26.26.0`
...
`docker pull ghcr.io/chris-garrett/node:26.23.0`
...
`docker pull ghcr.io/chris-garrett/devops:26.17.0`

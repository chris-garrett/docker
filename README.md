...
`docker pull ghcr.io/chris-garrett/python:26.19.0`
...
`docker pull ghcr.io/chris-garrett/rust:26.22.0`
...
`docker pull ghcr.io/chris-garrett/node:26.20.0`
...
`docker pull ghcr.io/chris-garrett/devops:26.14.0`

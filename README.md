...
`docker pull ghcr.io/chris-garrett/python:26.4.0`
...
`docker pull ghcr.io/chris-garrett/rust:26.4.0`
...
`docker pull ghcr.io/chris-garrett/node:26.4.0`
...
`docker pull ghcr.io/chris-garrett/postgres:26.4.0`

...
`docker pull ghcr.io/chris-garrett/python:26.11.0`
...
`docker pull ghcr.io/chris-garrett/rust:26.14.0`
...
`docker pull ghcr.io/chris-garrett/node:26.12.0`
...
`docker pull ghcr.io/chris-garrett/postgres:26.10.0`
...
`docker pull ghcr.io/chris-garrett/devops:26.8.0`
